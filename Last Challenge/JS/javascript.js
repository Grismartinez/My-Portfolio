...
function showSlides(n) {
    var slides = document.getElementsByClassName("Typing_Video"); // This takes all elements with the class name "mySlides" and stores them in the variable array "slides"
